...
class PickCompleteSchema(SixRiverSchema):
    ...
    pick_id = fields.Str(data_key='pickID', load_from="pickID", dump_to="pickID")
...
class PickTaskPickedSchema(SixRiverSchema):
    ...
    pick_id = fields.Str(required=True, data_key="pickID", load_from="pickID", dump_to="pickID")
    group_id = fields.Str(required=True, data_key="groupID", load_from="groupID", dump_to="groupID")
